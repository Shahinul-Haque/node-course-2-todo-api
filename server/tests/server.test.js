...
beforeEach(populateTodos);
  ...
  describe('POST /todos', () => {
    it('should create a new todo', (done) => {
      var text = 'Create a new todo text';
  ...
  it('should not create todo with invalid body todo',(done)=>{
...
describe('DELETE/todos/:id', ()=>{
     it('shoud be remove a todo',(done)=>{
...
describe('PATCH /todos/:id', () => {
    ...
    it('should not create the todos by other user', (done) => {
      var hexId = todos[0]._id.toHexString();
      var text = 'This should be the new text';
